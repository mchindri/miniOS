...
;Codul va fi scris in 16 bits caci in modul respectiv doar 16bits merge
[bits 16]                   
[org 7C00h]                ; because the MBR is loaded at 7C00h and runs in 16-bit Real Mode   
;Procesorul citeste primul sector si il pune la adresa respectiva. Aici e puss codul nostru si procesorul incepe sa le execute
BootMain:                  
    ;break                   
    ...
    int    13h             
    jnc    .success        
  ;citim inca noua sectoare cu 13h la adresa 0x7e00
